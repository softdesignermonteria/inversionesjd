var Application =  {
  ...
  evalCode: function(id) {
	...
	insertNavigation: function(selected) {
	  document.write('\
	  <h1><a href="http://prototype-window.xilinus.com"><img border=0 src="../../windows_js_1.3/documentation/js/pwc.gif"/></a></h1>\
    <div class="navigation">\
      <ul>\
        <li><a id="menu_documentation" href="../../windows_js_1.3/documentation/js/documentation.html">Documentation</a></li>\
        <li><a id="menu_samples" href="../../windows_js_1.3/documentation/js/samples.html">Samples</a></li>\
        <li><a id="menu_debug" href="../../windows_js_1.3/documentation/js/debug.html">Debug</a></li>\
        <li><a id="menu_themes" href="../../windows_js_1.3/documentation/js/themes.html">Themes</a></li>\
      </ul>\
    </div>');
