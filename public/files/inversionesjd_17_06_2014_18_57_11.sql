...
INSERT INTO `admin` VALUES (1,'admin','21232f297a57a5a743894a0e4a801fc3','superadministrador',1,2,'superadministrador','adminiziolite'),(2,'egulfo','81dc9bdb52d04dc20036dbd8313ed055','ERWIN MIGUEL GULFO VEGA',1,4,'administrador','adminiziolite');
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=latin1 AVG_ROW_LENGTH=5461 COMMENT='TABLA CLIENTES';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cobradores` (
  ...
  UNIQUE KEY `nit` (`nit`),
  KEY `municipios_id` (`municipios_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AVG_ROW_LENGTH=5461 COMMENT='TABLA CLIENTES';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci COMMENT='TABLA DE FACTURA';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci COMMENT='TABLA DETALLE FACTURA';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AVG_ROW_LENGTH=5461 COMMENT='TABLA DE DETALLE RECIBOS DE CAJA';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=57 DEFAULT CHARSET=latin1 COMMENT='TABLA DE RECIBOS DE CAJA';
/*!40101 SET character_set_client = @saved_cs_client */;
